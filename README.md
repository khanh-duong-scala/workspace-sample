# com-chilipeppr-workspace-khanh
A ChiliPeppr Workspace khanh.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / khanh
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-khanh |
| Name                  | Workspace / khanh |
| Description           | A ChiliPeppr Workspace khanh. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/khanh-duong/chillipeppr-workspace/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/khanhduong/chillipeppr-workspace |
| Github URL            | http://github.com/khanh-duong/chillipeppr-workspace |
| Test URL              | https://preview.c9users.io/khanhduong/chillipeppr-workspace/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/khanh-duong/chillipeppr-workspace/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-khanh"], // the id you gave your workspace
      function(myWorkspaceKhanh) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / khanh just got loaded.", myWorkspaceKhanh);
        myWorkspaceKhanh.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-khanh"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / khanh"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace khanh."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/khanh-duong/chillipeppr-workspace/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/khanhduong/chillipeppr-workspace"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/khanh-duong/chillipeppr-workspace"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://chillipeppr-workspace-khanhduong.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
